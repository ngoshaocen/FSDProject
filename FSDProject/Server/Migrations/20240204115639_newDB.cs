        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CSessionType = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CSRequests_Consultants_ConsultantID",
                        column: x => x.ConsultantID,
                        principalTable: "Consultants",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CSRequests_JobSeekers_JobSeekerID",
                        column: x => x.JobSeekerID,
                        principalTable: "JobSeekers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "3781efa7-66dc-47f0-860f-e506d04102e4", 0, "c91fdc12-3897-4e4d-96c3-29a889dc8954", "staff@localhost.com", false, "Staff", "User", false, null, "STAFF@LOCALHOST.COM", "staff@LOCALHOST.COM", "AQAAAAIAAYagAAAAEFuGmcb4sDysBUVzpu50W+mT0M2WkYDatmoi4gS2SVAnffvhB9Jd7R8uAzDbkyB0zQ==", null, false, "90b5b8e3-0203-468d-8b20-106e78e2a657", false, "staff@localhost.com" },
                    { "c8090b62-0e8c-4631-a3fb-717ebe2a55ab", 0, "1d0c7c81-561b-461f-bc55-331186806c52", "consultant@gmail.com", false, "Consultant", "User", false, null, "CONSULTANT@GMAIL.COM", "consultant@GMAIL.COM", "AQAAAAIAAYagAAAAEN0CxNmtvHHsIPZPmKSrZV4BsVpY2QfiUrnxBu8yjjQOuo7pu5U/vpVOvnK9dWn2yg==", null, false, "aa981f9b-60ac-4a43-9e7a-ad1cd21ee44d", false, "consultant@gmail.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 11, 19, 56, 38, 979, DateTimeKind.Local).AddTicks(8365), "1 Hour Consultation Session for Tim Loh.", 50, "Online", 1, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, "John Lim's Consultation", null },
                    { 2, new DateTime(2024, 2, 18, 19, 56, 38, 979, DateTimeKind.Local).AddTicks(8390), "1 Hour Consultation Session For James Teo.", 75, "In-Person", 2, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, "Jane Tan's Consultation", null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CSRequests_ConsultantID",
                table: "CSRequests",
                column: "ConsultantID");

            migrationBuilder.CreateIndex(
                name: "IX_CSRequests_JobSeekerID",
                table: "CSRequests",
                column: "JobSeekerID");
